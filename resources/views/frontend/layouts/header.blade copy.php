<header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="{{ route('frontend.menu', 'presentation') }}" class="@yield('presentation')">Qui sommes nous?</a></li>
          <li><a href="{{ route('frontend.menu', 'comment-postuler') }}" class="@yield('postuler')">Comment postuler?</a></li>
          <li><a href="{{ route('frontend.menu', 'conseils') }}" class="@yield('conseils')">Besoin de conseils?</a></li>
          <li><a href="{{ route('frontend.menu', 'nos-formations') }}" class="@yield('formations')">Nos Formations</a></li>
          <li><a href="{{ route('frontend.menu', 'nos-packs') }}" class="@yield('packs')">Nos packs</a></li>
          @if(Auth::check())
          <li><a href="{{ route('profile.edit') }}" class="@yield('projets')">Mes projets</a></li>
          @endif
        </ul>
