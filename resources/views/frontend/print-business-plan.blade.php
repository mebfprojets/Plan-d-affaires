...
<head>
  ...
  <!-- style -->
  <link rel="stylesheet" href="{{ public_path('/backend/assets/css/bootstrap.min.css') }}">
    ...
    <div class="col-lg-10 offset-1">
        <div class="model px-5" style="box-shadow: 2px 2px 5px 1px #999; padding: 1rem;">
            ...
            <div class="text-center py-5 my-5">
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('logo.png'))) }}" height="200">
            </div>
            ...
            <h4 class="card-title text-black fw-bold mt-1" id="1">II. PRÉSENTATION DU PROMOTEUR ET DE L'ENTREPRISE</h4>
            <h4 class="card-title text-black fw-bold m-t-40 my-3" id="3">1. Entreprise</h4>
            @if($business_plan->entreprise )
            <table class="table table-bordered" style="width: 100%">
                <tr class="py-2"><td><span class="fw-bold">Dénomination</span></td><td>{{ $business_plan->entreprise->denomination }}</td></tr>
                <tr class="py-2"><td><span class="fw-bold">Forme juridique</span></td><td>{{ $business_plan->entreprise->forme_juridique }}</td></tr>
                <tr class="py-2"><td><span class="fw-bold">Date de création prévue</span></td><td>{{ $business_plan->entreprise->date_creation_prevue }}</td></tr>
                <tr class="py-2"><td><span class="fw-bold">Localisation</span></td>
                <td>
