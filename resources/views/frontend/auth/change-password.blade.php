  ...
  <section id="contact" class="contact section">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4">
          <form action="{{ route('password.updates') }}" method="post" data-aos="fade-up" data-aos-delay="200">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            @if ($errors->any())
            ...
            <div class="form-group mb-3">
                <input type="password" class="form-control" name="current_password" placeholder="Ancien mot de passe" required>
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group">
                <button type="submit" class="form-control btn btn-success rounded submit px-3">Changer</button>
            </div>
