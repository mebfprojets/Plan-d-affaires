...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('roles.store') }}" method="POST" class="form-horizontal" novalidate>
                        {{ csrf_field() }}
                        <div class="form-body">
                            <h3 class="box-title">Nouveau rôle</h3>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 controls">
                                    <input type="text" name="nom_role" id="nom_role" class="form-control" placeholder="Nom rôle" required data-validation-required-message="Le champ libellé est obligatoire">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-2" for="description">Description</label>
                                <div class="col-md-4">
                                    <textarea name="description" id="description" class="form-control" cols="30" rows="5" placeholder="Description du rôle"></textarea>
                                </div>
                            </div>
                            <!--/row-->
                            <hr>
