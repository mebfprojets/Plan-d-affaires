...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Valeurs des paramètres</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Accueil</a></li>
            <li class="breadcrumb-item"><a href="{{ route('valeurs.index') }}">Valeurs des paramètres</a></li>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('valeurs.store') }}" method="POST" class="form-horizontal" novalidate>
                        {{ csrf_field() }}
                        <div class="form-body">
                            <h3 class="box-title">Nouvelle valeur de paramètre</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                            <input type="text" name="nom_valeur" id="nom_valeur" class="form-control" placeholder="Nom valeur" required data-validation-required-message="Le champ libellé est obligatoire">
                                        </div>
                                    </div>
                                    <!--/Libelle-->
                                    <!--Description-->
