                                        ...
                                        <tbody id="banque_area">
                                            @if($business_plan->entreprise && ($business_plan->entreprise->engagements)->count()>0)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control" id="type_duree" name="type_duree[]">
                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" class="form-control" name="montant_emp[]" placeholder="01"></td>
                                    ...
                                    <table class="table table-bordered" id="chargeTable{{ $charges->first()->id_valeur }}">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" min="0" id="cout_total_charge_{{ $charge_exploitation->id }}" class="form-control" name="cout_total_charge_{{ $charges->first()->id_valeur }}[]" disabled value="{{ number_format(floatval($charge_exploitation->cout_total), 0, ',', ' ') }}"></td>
                                                <td></td>
                                            </tr>
                                            @endforeach
                                            @else
